...
namespace BHXH.List.Business
{
    ...
    {
        public static IEnumerable<BHXH.Data.ListXaPhuong> GetAll()
        {
            BHXH.Data.BHXHEntities ctx = new Data.BHXHEntities();

            IEnumerable<BHXH.Data.ListXaPhuong> list;

            var query = from c in ctx.ListXaPhuong select c;
        ...
        {
            BHXH.Data.BHXHEntities ctx = new Data.BHXHEntities();
            Data.ListXaPhuong obj = GetNationality(XaPhuongID);
        ...
        public static BHXH.Data.ListXaPhuong GetNationality(int XaPhuongID)
        {
            BHXH.Data.BHXHEntities ctx = new Data.BHXHEntities();
            var query = from c in ctx.ListXaPhuong
                        where c.XaPhuongID == XaPhuongID
